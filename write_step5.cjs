...
const content = `export const step5_express_basics = {
  id: 5,
...
fs.writeFileSync('/Users/farhod/Desktop/github/js-uz/src/data/lessons/nodejs/step5_express_basics.js', content, 'utf8');
