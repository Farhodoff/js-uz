...
const quizzes = [
  ...
  },
  {
    ...
    options: ["err, data", "req, res", "in, out", "get, post"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ["res.url", "req.path", "req.url", "http.url"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["Not Found (Topilmadi)", "Internal Server Error (Server xatosi)", "OK (Hammasi joyida)", "Forbidden (Ruxsat yo'q)"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["server.start()", "server.run()", "server.open()", "server.listen()"],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ["res.send()", "res.stop()", "res.end()", "res.finish()"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["So'rovga HTML fayl ulaydi", "Serverni to'xtatadi", "Javobning status kodini va headerlarini (HTTP sarlavhalari) yozadi", "Faqat xatoliklarni qaytaradi"],
    correctAnswer: 2,
  ...
  },
  {
    id: 9,
    question: "Port nima?",
    options: ["Kema to'xtaydigan joy", "Dasturning tarmoqdan ma'lumot olish ulanish nuqtasi", "Modul nomi", "Tashqi server nomi"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ["Muvaffaqiyatli", "Server ishlamay qoldi", "Topilmadi (Not Found)", "So'rov noto'g'ri"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["text/plain", "text/html", "application/json", "multipart/form-data"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["GET, POST, PUT, DELETE ...", "200, 404, 500", "http, https, ftp", "json, xml, html"],
    correctAnswer: 0,
    explanation: "req.method - bu HTTP request metodlari: GET, POST, PUT, DELETE kabi."
  }
];

const fileContent = `export const step4_http_server = {
...
fs.writeFileSync('/Users/farhod/Desktop/github/js-uz/src/data/lessons/nodejs/step4_http_server.js', fileContent);
console.log('Done!');
