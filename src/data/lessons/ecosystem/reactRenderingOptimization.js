...
React Virtual DOM yaratadi va uni haqiqiy DOM bilan solishtiradi. Jarayon Reconciliation deb ataladi:
...
* **OQIBAT:** Har renderda yangi funksiya referensi yaratiladi va \\\`React.memo\\\` baribir bolani qayta render qiblyuboradi.
...
6. **Savol:** \\\`React.memo\\\` nima va u qanday ishlaydi?
   * **Javob:** Bu yuqori tartibli komponent (HOC) bo'lib, uning props-lari o'zgarmasa, ushbu komponentni qayta render bo'lishdan himoya qiladi.
...
8. **Savol:** List Virtualization (Virtualizatsiya) nima va u qachon ishlatiladi?
   * **Javob:** Katta hajmli ro'yxatlarni (masalan, 10 000+ satr) ekranga chizishda faqat viewport dagi elementlarni DOM-da saqlab, performance-ni oshirish texnikasi.
