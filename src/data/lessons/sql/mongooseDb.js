...
`,
  ...
  quizzes: [
    ...
    },
    {
      ...
      "correctAnswer": 1,
      "explanation": "Schema yordamida ma'lumotlar strukturasi loyihalanadi, Model esa shu loyiha asosida kolleksiya ustida CRUD amallarini bajaruvchi klass bo'lib xizmat qiladi."
    },
    {
      "id": 4,
    ...
    {
      "id": 8,
      "question": "Bitta hujjatni boshqa bir kolleksiyadagi hujjat bilan bog'lash (references) va so'rov paytida edi uni to'liq ma'lumotlar bilan almashtirish qanday ataladi?",
      "options": [
        "Aggregation",
        "Population",
        "Migration",
