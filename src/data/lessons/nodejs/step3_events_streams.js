...
`,
  ...
  },
  {
    ...
    "options": [
      ...
      "Binar ma'lumotlar bilan ishlash (saqlash/o'zgartirish) uchun",
      "HTML sahifalarni render qilish uchun"
    ],
    "correctAnswer": 2,
  ...
  },
  {
    ...
    "options": [
      "10 baytlik nol bilan to'ldirilgan buffer yaratadi",
      "Tarkibida '10' yozuvi bor buffer yaratadi",
      "10 megabayt xotira ajratadi",
      "Uzunligi noma'lum buffer yaratadi"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Tezligi ancha sekin bo'lgani uchun xavfsizroq",
      "Faylni kichik qismlarga (chunk) bo'lib RAMni to'ldirib yubormasdan o'qiydi",
      "U faylni faqat string qilib o'qiy oladi",
      "Qulayroq emas, doim fs.readFile yaxshi"
    ],
    "correctAnswer": 1,
  ...
  },
  {
    ...
    "options": [
      "O'qilayotgan stream ma'lumotlarini yozilayotgan streamga to'g'ridan-to'g'ri ulash",
      "Dasturni vaqtincha to'xtatib turish",
      "Kodni siqish (kompressiya)",
      "EventEmitterlarni birlashtirish"
    ],
    "correctAnswer": 0,
  ...
  },
  {
    ...
    "options": [
      "Farqi yo'q",
      "Transform o'qish va yozishni qila olmaydi",
      "Transform oqimida yozilayotgan va o'qilayotgan ma'lumotlar o'zaro bog'liq (masalan siqish yoki o'zgartirish jarayoni)",
      "Transform faqat string oladi"
    ],
    "correctAnswer": 2,
