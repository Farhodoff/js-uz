...
* **Action:** Redis caching o'rnatdim, database query-larini optimallashtirib indexlar qo'shdim.
* **Result:** Sayt tezligi 1.2 soniyaga tushdi va foydalanuvchilar konversiyasi 15% ga oshdi.
...
\`\`\`mermaid
graph TD
    S[Situation: Muammoni bayon qilish] --> T[Task: Vazifani aniqlash]
    T --> A[Action: Qilingan harakatlar]
    A --> R[Result: Erishilgan yutuq raqamlarda]
\`\`\`
...
| Qism | Ma'nosi | Tavsiya etilgan ulush |
| :--- | :--- | :--- |
| **Situation** | Vaziyat va muammo | 15% |
| **Task** | Sizga yuklatilgan maqsad | 15% |
| **Action** | Aynan siz bajargan ishlar | 50% |
| **Result** | Erishilgan o'lchovli yutuq | 20% |
`,
  exercises: [
  {
    "id": 1,
