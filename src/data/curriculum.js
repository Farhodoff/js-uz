...
export const curriculum = {
  ...
  ecosystem: {
    ...
    lessons: [
      ...
      { id: "dockerComposeDb", title: "Docker Compose va Ma", load: () => import("./lessons/ecosystem/dockerComposeDb.js").then(m => m.dockerComposeDb) },
  ...
  sql: {
    ...
    icon: "🗄️",
    lessons: [
      { id: "sqlIntro", title: "Ma", load: () => import("./lessons/sql/sqlIntro.js").then(m => m.sqlIntro) },
      { id: "sqlSyntax", title: "SQL Sintaksisi va Operatorlar", load: () => import("./lessons/sql/sqlSyntax.js").then(m => m.sqlSyntax) },
      { id: "sqlBasics", title: "SQL So", load: () => import("./lessons/sql/sqlBasics.js").then(m => m.sqlBasics) },
      { id: "sqlFiltering", title: "Ma", load: () => import("./lessons/sql/sqlFiltering.js").then(m => m.sqlFiltering) },
      ...
      { id: "sqlSubqueries", title: "SQL Subqueries (Ichki So", load: () => import("./lessons/sql/sqlSubqueries.js").then(m => m.sqlSubqueries) },
      { id: "sqlViews", title: "Ko", load: () => import("./lessons/sql/sqlViews.js").then(m => m.sqlViews) },
      ...
      { id: "sqlQueryOptimization", title: "So", load: () => import("./lessons/sql/sqlQueryOptimization.js").then(m => m.sqlQueryOptimization) },
      { id: "sqlModifications", title: "Ma", load: () => import("./lessons/sql/sqlModifications.js").then(m => m.sqlModifications) },
      { id: "prismaOrm", title: "Prisma ORM va Ma", load: () => import("./lessons/sql/prismaOrm.js").then(m => m.prismaOrm) },
