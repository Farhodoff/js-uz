...
export const curriculum = {
  ...
  basics: {
    ...
    lessons: [
      ...
      { id: "spreadBasics", number: "1.51", title: "Spread (...) Operatori: Yoyish", load: () => import("./lessons/js/01-basics/spreadBasics.js").then(m => m.spreadBasics) },
      ...
      { id: "dateBasics", number: "1.56", title: "Global Obyektlar: Date", load: () => import("./lessons/js/01-basics/dateBasics.js").then(m => m.dateBasics) },
      { id: "setBasics", number: "1.57", title: "Global Obyektlar: Set", load: () => import("./lessons/js/01-basics/setBasics.js").then(m => m.setBasics) },
      { id: "mapCollectionBasics", number: "1.58", title: "Global Obyektlar: Map", load: () => import("./lessons/js/01-basics/mapCollectionBasics.js").then(m => m.mapCollectionBasics) },
      { id: "windowDocumentBasics", number: "1.59", title: "DOM: window va document", load: () => import("./lessons/js/01-basics/windowDocumentBasics.js").then(m => m.windowDocumentBasics) },
      { id: "domSelectBasics", number: "1.60", title: "DOM: Elementni Tanlash", load: () => import("./lessons/js/01-basics/domSelectBasics.js").then(m => m.domSelectBasics) },
